        ...
        for line in lines:
            if len(line) >0:
                ...
                if notFound :
                    ...
                    notFound = False
                elif temparr[0] !="datetime" and temparr[0] != "" and temparr[4] != 0.0:
                    finalstring = finalstring + line
        #count += 1
        file.close()
