...
\section{Learning Goals}
	\begin{itemize}
		\item Collect relevant material from already existing data collections 
		\item Create an experiment to collect data on students sleeping patterns using mobilephones
		\item Design a (personalised?), adaptive (digital) solution to support cognitive behavioural therapy for sleep deprivation 
		\item Create a test experiment to evaluate on the designed solution
		\item ??
	\end{itemize}
